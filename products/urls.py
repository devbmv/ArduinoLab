...
urlpatterns = [
    ...
    path('microcontroller/<int:microcontroller_id>/', views.microcontroller_detail, name='microcontroller_detail'),
    ...
    path('edit-microcontroller/<int:microcontroller_id>/', views.edit_microcontroller, name='edit_microcontroller'),

    # Delete a microcontroller
    path('delete-microcontroller/<int:microcontroller_id>/', views.delete_microcontroller, name='delete_microcontroller'),
    ...
    path('add-features/<int:microcontroller_id>/', views.add_features, name='add_features'),
]
