...
class Microcontroller(models.Model):
    ...
    category = models.ForeignKey(Family, on_delete=models.CASCADE, related_name='microcontrollers', null=True, blank=True)
    ...
    bit_width = models.PositiveIntegerField(choices=BIT_WIDTH_CHOICES, null=True, blank=True)
    ...
    cpu_architecture = models.CharField(max_length=100, choices=CPU_ARCHITECTURE_CHOICES, null=True, blank=True)
    ...
    ram_kb = models.PositiveIntegerField(choices=RAM_CHOICES, help_text='RAM capacity in KB', null=True, blank=True)
    ...
    flash_memory_kb = models.PositiveIntegerField(choices=FLASH_MEMORY_CHOICES, help_text='Flash memory capacity in KB', null=True, blank=True)
    ...
    package_type = models.CharField(max_length=50, choices=PACKAGE_TYPE_CHOICES, null=True, blank=True)
